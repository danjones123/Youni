...
public class ExcelToDbMapper {
  public static AlevelSubject mapToAlevelSubject(ExcelHelperDTO excelHelperDTO) {

    return null;
  }

  public static CombineUniversityCourseAlevelSubject mapToUniversityCourseALevelSubject(ExcelHelperDTO excelHelperDTO) {
    return null;
  }
